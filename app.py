...
with tabs[0]:
    ...
    if not members.empty:
        ...
        c1.altair_chart(chart1, width=True)
        ...
        if not df_ends.empty:
            ...
            c2.altair_chart(chart2, width=True)
        else:
    ...
    if not members.empty:
        ...
        if not df_retention.empty:
            ...
            st.altair_chart(chart3, width=True)
        else:
...
with tabs[2]:
    ...
    with st.container():
        ...
        # Action button
        add_btn = st.button("✅ Add Member", width=True)
...
with tabs[3]:
    ...
    if members.empty:
        ...
        with st.form("edit_member_form"):
            ...
            # Save button
            save_btn = st.form_submit_button("💾 Save Changes", width=True)
